...
int DoIt( int argc, char * argv[], T )
{
  ...
  typedef itk::HessianToObjectnessMeasureImageFilter<InputImageType, OutputImageType> HessianToObjectnessFilterType;
  ...
  */
  ...
  hessianObjectness->SetInput(hessianGaussian->GetOutput());
  ...
  hessianObjectness->Update();

  // Write output volume
  typename OutputWriterType::Pointer writerOutput = OutputWriterType::New();
  writerOutput->SetFileName( outputVolume.c_str() );
  writerOutput->SetInput( hessianObjectness->GetOutput() );
  writerOutput->SetUseCompression(1);
  writerOutput->Update();
